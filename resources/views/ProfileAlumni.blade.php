...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-md-4 text-center">
            <img src="{{ asset('path/to/profile-picture.jpg') }}" alt="Foto Profil" class="img-fluid rounded-circle" style="width: 150px; height: 150px;">
        ...
        <div class="col-md-8">
            ...
            <div class="mb-4">
                ...
                <ul class="list-unstyled">
                    <li><strong>SD:</strong> {{ $user->education->sd }}</li>
                    <li><strong>SMP:</strong> {{ $user->education->smp }}</li>
                    <li><strong>SMA/SMK:</strong> {{ $user->education->sma_smk }}</li>
                </ul>
            </div>
            ...
            <div class="mb-4">
                ...
                <ul class="list-unstyled">
                    @foreach($user->work_experience as $experience)
                        <li>
                            <strong>{{ $experience->job_title }}</strong> at {{ $experience->company_name }} ({{ $experience->start_date }} - {{ $experience->end_date }})

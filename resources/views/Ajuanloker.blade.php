            ...
            <div class="modal-body">
                ...
                <form action="{{ route('update.status', $lowongan->id_lowongan_pekerjaan) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="status{{ $lowongan->id_lowongan_pekerjaan }}" name="status" onchange="toggleTextarea(this)">
                    ...
                    <!-- Textarea for alasan -->
                    <div class="mb-3" id="alasanContainer{{ $lowongan->id_lowongan_pekerjaan }}" style="display: none;">
                        <label for="alasan{{ $lowongan->id_lowongan_pekerjaan }}" class="form-label"><strong>Alasan Tidak Dipublikasi:</strong></label>
